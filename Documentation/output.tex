...
\begin{document}
    ...
    \begin{flushright}
        \textit{%Dedicatoria,\\
        Una dedicatoria. Puede alargarse varias líneas, e incluso contener
        comas.}
    \end{flushright}
    ...
    Bloque de texto que permite alargarse lo que deseemos, incluir comas y
    cualquier tipo de caracter dentro de este encabezado en YAML siempre y
    cuando mantengamos la indentación del bloque.
